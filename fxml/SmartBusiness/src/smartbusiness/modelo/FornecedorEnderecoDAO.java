...
public class FornecedorEnderecoDAO {
     ...
     * @param fe objeto da classe Fornecedores Endereço
     ...
     * @param fe Objeto da classe Fonecedores Endereço
     * @throws SQLException lança uma exceção
     */
    public static void update(FornecedorEndereco fe) throws SQLException{
        ...
        stm.setString(6, fe.getPais());
        stm.setString(7, fe.getCep());
        stm.setInt(8, fe.getPk_endereco());
     ...
     * @param pk_endereco Chave primária de Fornecedor Endereço
     * @throws SQLException lança uma exceção
     */
    public static void delete (int pk_endereco) throws SQLException{
        ...
        String sql = "DELETE FROM forncedores_enderecos WHERE pk_endereco=?";
    ...
    /**
     * Metodo responsavel por excuir um endereco do BD
     * @param fe Objeto da classe Fornecedor Endereço
     * @throws SQLException lança uma exceção
     */
    
    public static void delete (FornecedorEndereco fe) throws SQLException{
        Connection conn = BancoDados.createConnection();
        String sql = "DELETE FROM fornecedores WHERE pk_endereco=?";
        PreparedStatement stm = conn.prepareStatement(sql);
