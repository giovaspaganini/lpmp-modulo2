...
public class CompraDAO {
    ...
    public static String retrieveRelatorioCompras() throws SQLException{
           String res = "";
                      Connection conn = BancoDados.createConnection();
           String sql = "select  f.nome ,(qtd * valor_unitario) total_compra , c.datas, fs.valor ,\n" +
"                        fs.valor >= (qtd * valor_unitario)  totalmente_paga from\n" +
...
"                        GROUP BY f.nome , valor_unitario, qtd ,datas, valor";
           ...
           while (rs.next()) {
                String nome = rs.getString("nome");
                  ...
                  float valorsoma = rs.getFloat("total_compra");
